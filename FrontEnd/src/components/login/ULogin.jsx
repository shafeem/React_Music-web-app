...
import { LoginSocialGoogle,LoginSocialInstagram,LoginSocialGithub } from "reactjs-social-login";
...
function UserLogin() {
    ...
    const googleAuth = async (datas)=>{
        console.log(datas,"this is the datakkkk")
        setUser(datas)
        ...
        await axios({
            ...
            console.log(res.data.token,'this is the data');
            navigate("/")
        })
    }
  ...
  return (
    <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
      <div className="w-full p-28 m-auto bg-inherit rounded-md shadow-xl lg:max-w-xl mb-56">
        <form className="mt-0">
          <div className="mb-10">
